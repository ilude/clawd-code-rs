...
(b) any current or future parent, subsidiary, affiliate, successor, assignee, or any entity
under common control with Anthropic, PBC;

(c) any current officer, director, or principal executive officer of Anthropic, PBC;

(d) any former officer, director, or principal executive officer of Anthropic, PBC, to the
extent such person accesses, uses, or directs access to or use of the Software in a
professional, commercial, advisory, litigation, investigative, or representative capacity;

(e) any law firm, lawyer, attorney, expert, consultant, contractor, investigator, vendor,
service provider, outsourcing provider, or other person or entity engaged by, retained by,
paid by, instructed by, or acting under contract with:
    (i) Anthropic, PBC;
    (ii) any entity described in subsection (b);
    (iii) any person described in subsection (c); or
    (iv) any person described in subsection (d);

(f) any business, organization, or individual acting at the request of, for the benefit of,
under the direction of, in coordination with, or pursuant to a contractual, agency,
fiduciary, advisory, employment, or retained relationship with any person or entity described
in subsections (a) through (e); and

(g) any automated system, bot, crawler, scraper, indexing system, retrieval agent, software
agent, model training pipeline, evaluation harness, or AI scanning agent operated by, for,
on behalf of, under contract with, or for the benefit of any person or entity described in
subsections (a) through (f).

"Acting on behalf of" includes acting under instruction from, under contract with, retained
by, employed by, representing, coordinating with, or providing services for the benefit of
an Excluded Party, whether directly or indirectly.

2. Grant of Rights

Subject to the terms and conditions of this License, the copyright holder grants to all
persons and entities other than Excluded Parties a non-exclusive, revocable, non-transferable
license to access, view, use, copy, modify, and distribute the Software.

3. Exclusion and Prohibition

Notwithstanding any other provision of this License, no rights are granted to any Excluded
Party.

No Excluded Party may access, view, copy, download, use, execute, modify, benchmark,
analyze, index, scrape, train on, evaluate against, distribute, or create derivative works
of the Software, in whole or in part, whether directly or indirectly.

Any access to or use of the Software by an Excluded Party is unauthorized, unlicensed, and
expressly prohibited.

4. Condition of Access and Use

By accessing, viewing, copying, downloading, indexing, scanning, using, modifying, or
distributing the Software, you represent and warrant that:

(a) you are not an Excluded Party;
(b) you are not acting on behalf of an Excluded Party; and
(c) you are not accessing or using the Software for the benefit of an Excluded Party,
...
(b) preserve all copyright, attribution, and notice provisions; and
(c) not remove, obscure, contradict, or alter the restrictions applicable to Excluded Parties.

6. Derivative Works

Derivative works and modifications are permitted only for persons and entities that are not
Excluded Parties and are not acting on behalf of or for the benefit of an Excluded Party.

Any derivative work distributed under this License must remain subject to this License and
must preserve the exclusions, prohibitions, and conditions set forth herein.

7. Termination

Any breach of this License automatically and immediately terminates all rights granted under
this License to the breaching party.

Upon termination, the breaching party must immediately cease all access to and use of the
Software and destroy or permanently delete all copies of the Software and any derivative
...
This License does not grant any right, title, or interest in or to any trademarks, service
marks, trade names, logos, or branding of the copyright holder, except as strictly necessary
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL THE COPYRIGHT HOLDER
